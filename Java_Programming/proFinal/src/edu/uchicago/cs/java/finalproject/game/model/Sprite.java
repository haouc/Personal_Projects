...
public abstract class Sprite implements Movable {
    ...
    private Point pntLeft;
    private Point pntRight;
    ...
    public void setLeft(Point pntParam){
        pntLeft = new Point((int)pntCenter.getX()-25, (int)pntCenter.getY());
    }

    public Point getRight(){
        return pntRight;
    }
    public void setRight(Point pntParam){
        pntRight = new Point((int)pntCenter.getX()+25, (int)pntCenter.getY());
    }
