...
//    private static UFO badShip;
	private static Asteroid sAsteroid = new Asteroid(0);
...
//        if(sAsteroid.getSize() >= 2)
        count++;
		lScore =lScore + lParam;
        if(lScore % 100 == 0) nNumFalcon++;
	}
	...
	public static CopyOnWriteArrayList<Movable> movDebris() {
		return movDebris;
	}
